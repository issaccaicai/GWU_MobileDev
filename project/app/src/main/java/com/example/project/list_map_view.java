...
public class list_map_view extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_map_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id){
                    case R.id.navigation_home:
                        Intent intent = new Intent(list_map_view.this, campus.class);
                ...
                switch(id){
                    case R.id.navigation_profile:
                        Intent intent = new Intent(list_map_view.this, profile.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        return true;
                }
                switch(id){
                    case R.id.navigation_logout:
                        ...
                        editor3.remove("like");
                        editor3.commit();
                        Intent intent = new Intent(list_map_view.this, login.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        return true;
                }
...
//
    ...
    public void forward(int position){
        ...
        Intent intent = new Intent(list_map_view.this,MapsActivity.class);
