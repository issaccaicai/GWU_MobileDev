    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        public void onInfoWindowClick(Marker arg0) {
            if(arg0 != null && arg0.getTitle().equals("G Street")){
                Intent intent1 = new Intent(foggy_bottom.this, MapsActivity.class);
                startActivity(intent1);}

            if(arg0 != null && arg0.getTitle().equals("Elliott School")){
                Intent intent2 = new Intent(foggy_bottom.this, MapsActivity.class);
                startActivity(intent2);}

            if(arg0 != null && arg0.getTitle().equals("Amsterdam Hall")){
                Intent intent3 = new Intent(foggy_bottom.this, MapsActivity.class);
                startActivity(intent3);}

            if(arg0 != null && arg0.getTitle().equals("University Student Center Garage")){
                Intent intent4 = new Intent(foggy_bottom.this, MapsActivity.class);
